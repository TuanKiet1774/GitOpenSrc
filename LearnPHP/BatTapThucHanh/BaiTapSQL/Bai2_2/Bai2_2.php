...
<head>
  ...
  <title>Bài 2.2 Lưới định dạng</title>
</head>
<style>
  * {
    margin: 0;
...
<body>
  <div class="container">
    ...
    <table border="1">
      ...
      //   echo "<tr>";
      //   $col = mysqli_fetch_array($result);
      //   echo "<td style = 'background-color: $color;' >" . $col['Ma_khach_hang'] . "</td>";
      //   echo "<td style = 'background-color: $color;'>" . $col['Ten_khach_hang'] . "</td>";
      //   $gt = $col[Phai] == 1 ? "Nam" : "Nữ";
      //   echo "<td style = 'background-color: $color; text-align: center'> $gt </td>";
      //   echo "<td style = 'background-color: $color;'>" . $col['Dia_chi'] . "</td>";
      //   echo "<td style = 'background-color: $color;'>" . $col['Dien_thoai'] . "</td>";
      //   echo "<td style = 'background-color: $color;'>" . $col['Email'] . "</td>";
      //   echo "</tr>";
      // }
